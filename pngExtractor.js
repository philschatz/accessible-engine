...
.on('parsed', function() {
  ...
  const sprites = [
    ...
    ['GongPlayMusic1', 'GongPlayMusic2', 'GongPlayMusic3', 'GongPlayMusic4', 'GongPlayMusic5', 'GongPlayMusic6', 'GongRed', 'PillarRed'],
    ['Key1', 'Key2', 'Key3', 'Key4', 'Key5', 'Key6', 'GongBlue', 'PillarBlue'],
    ['FloorSquareDone', 'FloorDiamondDone', 'FloorPoof1', 'FloorPoof2', 'FloorPoof3Diamond', 'FloorPoof3Square', 'GongYellow', 'PillarYellow'],
